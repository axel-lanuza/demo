		...
		public function init() {
			...
			$blocks = apply_filters('fpd_settings_blocks', array(
				...
				'advanced_colors' => array(
					'hex-names' => __('Color Names', 'radykal'),
					'color-prices' => __('Color Prices', 'radykal'),
				),
				'woocommerce' => array(
					'wc-product-page' => __('Product Page', 'radykal'),
					'wc-cart' => __('Cart', 'radykal'),
					'wc-order' => __('Order', 'radykal'),
			...
			self::$radykal_settings->add_blocks_description(array(
				'default-image-options' => __('The default options for added images from users and Designs.', 'radykal'),
				...
				'purchase-codes' => __('Deprecated: Please use the official <a href="https://envato.com/market-plugin/" target="_blank">Envato Market plugin to update all of your purchased plugins and themes</a>.', 'radykal'),
			));
			...
			self::$radykal_settings->add_block_options( 'wc-cart', $wc_options['wc-cart']);
			self::$radykal_settings->add_block_options( 'wc-order', $wc_options['wc-order']);
